...
void SetMouse1PressedCallback(const bool& value);
...
void SetMouseClickPosition(const glm::vec2& value) { SetMouseClickPositionCallback(value); }; 
void SetMouseClickPositionCallback(const glm::vec2& value);
...
void SetMousePosition(const glm::vec2& value) { SetMousePositionCallback(value); }; 
void SetMousePositionCallback(const glm::vec2& value);
