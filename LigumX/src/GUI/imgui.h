...
namespace ImGui
{
	...
	IMGUI_API bool          DragLong(const char* label, long* v, float v_speed = 1.0f, long v_min = 0, long v_max = 0, const char* display_format = "%.0f");                                       // If v_min >= v_max we have no bound
