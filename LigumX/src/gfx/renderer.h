...
public:
	...
	void RenderDebugWays(const glm::mat4& modelToWorld, ProgramPipeline* programPipeline, const std::vector<int>& displayFlags, const std::vector<glm::vec3>& wayDebugColors, Entity* selectedEntity);
