...
{ "GammaExponent", PIDX_GammaExponent, offsetof(PostEffects, m_GammaExponent), 0, LXType_float, sizeof(float), LXType_float, false, LXType_None, false, 0, 0, 0, 0,}, 
...
void PostEffects::ShowPropertyGrid()
{
	...
	LXIMGUI_SHOW_FLOAT("GammaExponent", m_GammaExponent);
