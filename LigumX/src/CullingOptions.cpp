...
{
{ "ObjectID", PIDX_ObjectID, offsetof(CullingOptions, m_ObjectID), 0, LXType_int, false, LXType_None, 0, 0, 0, }, 
{ "Name", PIDX_Name, offsetof(CullingOptions, m_Name), 0, LXType_stdstring, false, LXType_None, 0, 0, 0, }, 
{ "CullEntities", PIDX_CullEntities, offsetof(CullingOptions, m_CullEntities), 0, LXType_bool, false, LXType_None, 0, 0, 0, }, 
