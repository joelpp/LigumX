...
{ "UpVector", PIDX_UpVector, offsetof(Camera, m_UpVector), 0, LXType_glmvec3, false, LXType_None, 0, 0, 0, 0,}, 
{ "ViewMatrix", PIDX_ViewMatrix, offsetof(Camera, m_ViewMatrix), 0, LXType_glmmat4, false, LXType_None, PropertyFlags_Hidden | PropertyFlags_Transient, 0, 0, 0,}, 
{ "ViewMatrixNoTranslation", PIDX_ViewMatrixNoTranslation, offsetof(Camera, m_ViewMatrixNoTranslation), 0, LXType_glmmat4, false, LXType_None, PropertyFlags_Hidden | PropertyFlags_Transient, 0, 0, 0,}, 
{ "ProjectionMatrix", PIDX_ProjectionMatrix, offsetof(Camera, m_ProjectionMatrix), 0, LXType_glmmat4, false, LXType_None, PropertyFlags_Hidden | PropertyFlags_Transient, 0, 0, 0,}, 
{ "ViewProjectionMatrix", PIDX_ViewProjectionMatrix, offsetof(Camera, m_ViewProjectionMatrix), 0, LXType_glmmat4, false, LXType_None, PropertyFlags_Hidden | PropertyFlags_Transient, 0, 0, 0,}, 
...
{ "ViewSize", PIDX_ViewSize, offsetof(Camera, m_ViewSize), 0, LXType_float, false, LXType_None, 0, 0, 0, 0,}, 
{ "MovementSpeed", PIDX_MovementSpeed, offsetof(Camera, m_MovementSpeed), 0, LXType_float, false, LXType_None, 0, 0, 2000, 0,}, 
{ "KeyMovementSpeedIncreaseFactor", PIDX_KeyMovementSpeedIncreaseFactor, offsetof(Camera, m_KeyMovementSpeedIncreaseFactor), 0, LXType_float, false, LXType_None, 0, 0, 0, 0,}, 
};
