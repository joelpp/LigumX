...
void SetPosition(const glm::vec3& value) { SetPositionCallback(value); }; 
...
void SetRotationAxis(const glm::vec3& value) { SetRotationAxisCallback(value); }; 
void SetRotationAxisCallback(const glm::vec3& value);
glm::vec3& GetScale() { return m_Scale; }; 
void SetScale(const glm::vec3& value) { SetScaleCallback(value); }; 
