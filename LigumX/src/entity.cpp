...
{ "Position", PIDX_Position, offsetof(Entity, m_Position), 0, LXType_glmvec3, false, LXType_None, PropertyFlags_SetCallback | PropertyFlags_Adder, 0, 0, WriteSetCallbackFunction(Entity, Position, glm::vec3),}, 
...
{ "RotationAxis", PIDX_RotationAxis, offsetof(Entity, m_RotationAxis), 0, LXType_glmvec3, false, LXType_None, PropertyFlags_SetCallback, 0, 0, 0,}, 
{ "Scale", PIDX_Scale, offsetof(Entity, m_Scale), 0, LXType_glmvec3, false, LXType_None, PropertyFlags_SetCallback, 0, 0, 0,}, 
