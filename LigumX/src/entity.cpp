...
{ "RotationAngle", PIDX_RotationAngle, offsetof(Entity, m_RotationAngle), 0, LXType_float, false, LXType_None, PropertyFlags_SetCallback, 0, 0, WriteSetFunction(Entity, RotationAngle, float),}, 
...
{ "HasMoved", PIDX_HasMoved, offsetof(Entity, m_HasMoved), 0, LXType_bool, false, LXType_None, PropertyFlags_SetCallback, 0, 0, WriteSetFunction(Entity, HasMoved, bool),}, 
{ "PickingID", PIDX_PickingID, offsetof(Entity, m_PickingID), 0, LXType_float, false, LXType_None, 0, 0, 0, 0,}, 
{ "Model", PIDX_Model, offsetof(Entity, m_Model), 0, LXType_Model, true, LXType_None, PropertyFlags_SetCallback, 0, 0, WriteSetFunction(Entity, Model, Model*),}, 
